...
from PyQt6.QtWidgets import QListWidget, QWidget, QMenu, QTextEdit, QDialog, QVBoxLayout, QListWidgetItem, \
    QGraphicsItem, QAbstractItemView, QMessageBox
...
class EqnView(QListWidget):
    ...
    def insert_item(self, equation):
        ...
        self.addItem(item)
        self._node().equations.add(equation)
